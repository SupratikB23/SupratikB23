...
| 📰 [**BrandSCOPE**](https://github.com/SupratikB23/BrandSCOPE) | Self-hosted brand content engine - scrapes brand DNA, researches live trends & writes SEO/AEO/GEO-optimized articles in the brand's own voice | `Javascript` `Python` `SEO GEO AEO` `NLP` |
